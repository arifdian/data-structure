...
public class MyGLSurfaceView extends GLSurfaceView {
    ...
    public boolean onTouchEvent(MotionEvent pEvent) {
        ...
        if(pEvent.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            System.out.println("C343 Lab 05 ---------------------------------- ");

            //name is a local variable
//create an instance from the RunTimes class
...
// ...
            ...
            // setting n to 10000 will break Example 7,
            // when the Android runtime will run out of memory!
            // runtimes.countInstructions(10000);
//  etc.
            Int2DArray2 a = new Int2DArray2(10000000);
